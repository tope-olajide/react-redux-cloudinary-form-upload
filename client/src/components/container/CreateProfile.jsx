...
class CreateProfile  extends Component {
    ...
    handleFormReset = () => {
      ...
      handleFormSubmit = files => {
        ...
        const uploaders = this.state.profile.map (file => {
          ...
          return axios.post("https://api.cloudinary.com/v1_1/temitope/image/upload", formData, {
        ...
        axios.all(uploaders).then((data) => {
          alert('Success!!!: Upload picture successfully, now saving to database')
    ...
    render() {
        return (
<CreateProfilePage files = {this.state}
onDrop = {this.onDrop}
